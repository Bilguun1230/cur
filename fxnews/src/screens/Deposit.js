...
const Withdraw = ({navigation}) => {
  ...
  const handleDeposit = async() => {
    ...
    try {
      ...
      Alert.alert("Амжилттай", `${selectedCard.name} ашиглан ${amount} орлого орлоо.`);
      navigation.goBack();
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Цэнэглэх</Text>
      ...
      <Text style={styles.inputLabel}>Орлого оруулах дүн:</Text>
      <TextInput
        style={styles.input}
      ...
      <TouchableOpacity style={styles.button} onPress={handleDeposit}>
        <Text style={styles.buttonText}>Цэнэглэх</Text>
      </TouchableOpacity>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity style={styles.cancelbutton} onPress={closeInputBox}>
